...
public class ProductServiceImpl implements ProductService {
    ...
    // cambiarlo por la inyeccion de dependencias por autowired si eso
    ...
    public Product getProductById(Long id) {
        return productRepository.findById(id).orElseThrow(() -> new RuntimeException("Prodcuto no encontrado"));
    }
